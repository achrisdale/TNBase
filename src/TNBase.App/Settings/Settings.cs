...
{
    public static SettingDefinition AssociationName => new(Key: "Association.Name", Name: "Association Name", Description: "Title shown on the main page of the application and other forms.", Category: "General", SettingType.Text, TypeOptions: "Required", Order: 0, DefaultValue: "Birmingham Talking Newspaper Association");
