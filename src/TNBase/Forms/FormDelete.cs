    ...
    public partial class FormDelete : Form
    {
        ...
        private void UpdateMemStickReceived()
        {
            toolStripStatusLabel.Text = CanPermanentlyDelete ?
                $"Listener has no player or wallets, therefore it's data will be deleted and the wallet number reserved for {Properties.Settings.Default.DaysToReserveDeletedWallet} days" :
