...
namespace TNBase
{
	public partial class FormPrintUnreturnedSpeakers
	{
		...
		private void printDormantDoc_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
		{
			...
			g.DrawString("Listeners who have been deleted but have not returned their speakers.", reportFontSmall, Brushes.Black, 150, 130, StringFormat.GenericTypographic);
