...
namespace TNBase
{
	...
	public partial class FormMain
    {
        ...
        private void btnScanIn_Click(object sender, EventArgs e)
        {
            ...
            {
                var formScanIn = new FormScanIn();
                formScanIn.setup(this);
        ...
        {
            var form = new FormPrintRecentListeners();
            form.Show();
            form.setupForm(true);
        }
